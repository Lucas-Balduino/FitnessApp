...
const exercicios = [
  ...
  },
  {
    ...
    reps: '10',
    descanso: '90s',
    imagem: 'https://images.unsplash.com/photo-1592656094267-764a45160876?q=80&w=800&auto=format&fit=crop',
  },
  {
    id: '3',
    nome: 'SAQUE VIAGEM',
...
export default function TreinoVolei({ fechar }) {
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          <View style={styles.titleContainer}>
            <Text style={styles.mainTitle}>VOLEIBOL</Text>
            <Text style={styles.subtitle}>
              O voleibol é um esporte de alta intensidade que desenvolve explosão muscular, reflexos rápidos e excelente coordenação motora. As constantes movimentações, saltos e ataques fortalecem os membros superiores e inferiores, exigindo também uma grande sinergia entre todos os jogadores da equipe.
            </Text>
          </View>
          ...
          <View style={styles.tipCard}>
            ...
            <Text style={styles.tipText}>
              Mantenha as pernas flexionadas na recepção e salte usando os braços como impulso.
            </Text>
          </View>
